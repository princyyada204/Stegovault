...
export default function UnifiedEmbed() {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 p-6 rounded-3xl border transition-all duration-300
                bg-white/60 backdrop-blur-xl border-white/50 shadow-2xl shadow-indigo-500/5
            ...
            >
                <div>
                    ...
                    >
                        {mediaType === 'image' ? 'Securely embed encrypted data into PNG images.' : 'Hide encrypted data inside WAV audio waveforms.'}
                    </p>
                </div>
            ...
            <div className="transition-all duration-300">
                {mediaType === 'image' ? <Embed /> : <AudioEmbed />}
            </div>
        </div>
    );
}
